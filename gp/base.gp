...
set yrange[0:1.1]
plot "data/NAMEX.data" using (bin($2,binwidth)):(1.0/m) smooth freq with boxes lc rgb "#35BB99" title "Calculated P",\
     "data/NAMEX.data" using 2:3 pt 7 ps 0.5 lc rgb "#FF0000" title "Expected P"
